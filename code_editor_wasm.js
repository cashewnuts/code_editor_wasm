...
export class CodeEditorWorkspace {
    ...
    */
    load_component(value) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.codeeditorworkspace_load_component(retptr, this.__wbg_ptr, addBorrowedObject(value));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_7fe8e5628f82c299 = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('code_editor_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
